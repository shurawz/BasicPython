...
# Function of command: function or method to be called when the button is clicked.
...
def score_hand(hand):
    ...
    for next_card in hand:
        ...
        # if we would bust, check if there is an ace ans subtract 10
        if score > 21 and ace:
            score -= 10
            ace = False
    return score
...
# fg="white" makes the 'dealer' 's colour white
